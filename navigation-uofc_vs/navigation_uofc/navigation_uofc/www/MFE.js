/*
 * JS for MFE generated by Appery.io
 */
...
function MFE_js() {
    ...
    var n2id_buf = {
        'mobilebutton_7': 'MFE_mobilebutton_7',
        'html_2': 'MFE_html_2',
        'mobilenavbar_3': 'MFE_mobilenavbar_3',
        'mobilenavbaritem_4': 'MFE_mobilenavbaritem_4'
    };
    ...
    function MFE_windowEvents() {

        $('#MFE').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function MFE_elementsExtraJS() {
        // screen (MFE) extra code
    ...
    function MFE_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#MFE_mobileheader [name="mobilebutton_7"]').on({
        ...
        }, '#MFE_mobileheader [name="mobilebutton_7"]');

        $(document).off("click", '#MFE_mobilefooter [name="mobilenavbaritem_4"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
        ...
        }, '#MFE_mobilefooter [name="mobilenavbaritem_4"]');

    };

    $(document).off("pagebeforeshow", "#MFE").on("pagebeforeshow", "#MFE", function(event, ui) {
        Apperyio.CurrentScreen = "MFE";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#MFE").on("pagecreate", "#MFE", function(event, ui) {
